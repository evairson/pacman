...
//        assertEquals(tempDir, result, "Inky devrait aller au SUD si BlinkyAI retourne le NORD");
//
//        //DIRECTION NORD
//        //définir blinkyDirection :
...
//        assertEquals(tempDir, result, "Inky devrait aller au NORD si BlinkyAI retourne le SUD");
//
//        //DIRECTION EAST
//        //définir blinkyDirection :
...
//        InkyAI.setRd(mockRandom);
//        result = InkyAI.getDirection(config, pacPos, ghostPos, pacDir);
//        assertEquals(tempDir, result, "Inky devrait aller à l'EAST si BlinkyAI retourne l'WEST'");
//
//        //DIRECTION WEST
//        //définir blinkyDirection :
